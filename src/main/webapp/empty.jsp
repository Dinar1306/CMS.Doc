...
<head>
    ...
    <title>Empty search request!</title>
</head>
...
<!--enctype="application / x-www-form-urlencoded"  multipart/form-data  -->
    <fieldset>
        ...
        <p><label class="w3-left">Дата:&nbsp;c&nbsp;&nbsp;</label><input class="w3-input w3-quarter" name="data1" type="date" id="data1" ></p>
        ...
        <br><br>
        <p><label class="w3-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;по&nbsp;</label><input class="w3-input w3-quarter" name="data2" type="date" id="data2" ></p>
    ...
    <p>Пустой запрос! Задайте один или более параметров для поиска.</p>
</form>
